...
@Test(priority = 2, description = "Create Set From File")
	...
	public void PrimaryColumn_Test() throws Throwable  {
		try {
			...
			objSetPage.PrimaryColumn(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void RowsPerPageOptions_Test() throws Throwable  {
		try {
			...
			objSetPage.RowsPerPageOptions(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void DefaultValue100_Test() throws Throwable  {
		try {
			...
			objSetPage.DefaultValue100(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void PrimarySecondaryNotNull_Test() throws Throwable  {
		try {
			...
			objSetPage.PrimarySecondaryNotNull(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void PrimarySecondaryNotSame_Test() throws Throwable  {
		try {
			...
			objSetPage.PrimarySecondaryNotSame(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
			BasePage.screenshotOnPass("PrimarySecondaryNotNull");
		    BasePage.onSuccessMeassage("PrimarySecondaryNotNull", "PrimarySecondaryNotNull", "Module - SET , Description of the test executed : Primary and Secondary columns are not same");
    
			
		}
		catch(Exception ex)
		{
			BasePage.captureScreenshot("PrimarySecondaryNotSame");
			BasePage.onFailreMeassage(ex.getMessage(),"PrimarySecondaryNotSame","Module - SET , Description of the test executed : Primary and Secondary columns are not same");
		}
		catch(AssertionError ex)
		{
	...
	public void MinimizeCard_Test() throws Throwable  {
		try {
			...
			objSetPage.MinimizeCard(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void CancelGridChanges_Test() throws Throwable  {
		try {
			...
			objSetPage.CancelGridChanges(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void RowsPerPageOptions69_Test() throws Throwable  {
		try {
			...
			objSetPage.RowsPerPageOptions69(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void RowsPerPageOptions70_Test() throws Throwable  {
		try {
			...
			objSetPage.RowsPerPageOptions70(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void PrimaryColumnRevertsToDefault_Test() throws Throwable  {
		try {
			...
			objSetPage.PrimaryColumnRevertsToDefault(setName, entity, searchText, gridNoOfRows, gridPrimaryColumn, gridSecondaryColumn);
			//			objSetPage.GridChanges("GridSet", "Disease", "Kera", "10", "Definition", "Identifier");
			//onSuccessMeassage("Grid Settings are Modified Successfully in Set Expand");
	...
	public void NumeralDisplayed_Test() throws Throwable 
	{
		...
		{
			BasePage.captureScreenshot("NumeralDisplayed");
			BasePage.onFailreMeassage(ex.getMessage(),"NumeralDisplayed","Module - SET , Description of the test executed : NumeralDisplayed");
