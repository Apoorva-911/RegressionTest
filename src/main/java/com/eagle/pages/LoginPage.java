...
public class LoginPage extends BasePage{
	...
	public void MicrosoftLogin() throws Throwable{
		try {
			...
			//BasePage.CompareAttributeText("alt","Microsoft",newLogo);
			BasePage.CompareAttributeText("role","presentation",newLogo);
	...
	public void CodeVerification() throws Throwable{
		...
		//mylogin	//wait.until(ExpectedConditions.visibilityOf(verificationCode));
			//mylogin	//BasePage.click(verificationCode);
			//mylogin		wait.until(ExpectedConditions.visibilityOf(CodeTextBox));
			//mylogin		Thread.sleep(10000);
			...
			//mylogin	ExtentTestManager.getTest().log(Status.PASS,"The second factor authentication was given manually");
			int i=0;
			while(i<15) {
				try {
	...
	public void loginTo() throws Throwable{
		...
		try {
			try {
				...
				this.setCredentials();
				this.clickLogin();
				wait.until(ExpectedConditions.visibilityOf(newLogo));
	...
	//added code to login using id and password
  	public void loginTo1() throws InterruptedException, AWTException{
