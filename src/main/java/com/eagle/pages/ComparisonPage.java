...
public class ComparisonPage extends BasePage{
	...
	public void ExpandAddFromSet(String setToAdd, String entityToSelect, String textToSearchInSet, String ComparisonName, String ControlSetName, String textToSearchInComparison) throws Throwable {    // Add from a set
		try {
			...
			System.out.println();
			System.out.println("setToAdd : "+setToAdd);
			System.out.println();
			
			System.out.println();
			System.out.println("entityToSelect : "+entityToSelect);
			System.out.println();
			
			System.out.println();
			System.out.println("textToSearchInSet : "+textToSearchInSet);
			System.out.println();
            ...
            System.out.println();
            System.out.println("ComparisonName : "+ComparisonName);
			System.out.println("ControlSetName : "+ControlSetName);
			System.out.println("entityToSelect : "+entityToSelect);
			System.out.println("textToSearchInComparison : "+textToSearchInComparison);
			System.out.println();
			...
			String NoOfRecordsInitial = ItemCountInExpand.getText();
			System.out.println("NoOfRecordsInitial : "+NoOfRecordsInitial);  //no. of records in comparison
			System.out.println();
			System.out.println();
			this.editCard();
			this.addItemsExpand();
			...
			waitforAnElement(ItemCountInExpand);
			String NoOfRecordsFinal = ItemCountInExpand.getText();
			System.out.println("NoOfRecordsFinal : "+NoOfRecordsFinal);
			System.out.println();
			System.out.println();
			this.CompareTwovalues(NoOfRecordsInitial,NoOfRecordsFinal);//ok
			
			

			System.out.println();
			System.out.println();
			System.out.println("setItems : "+setItems.size());
			
			
			objSetPage.verifyAfterAdd(setItems);
			//objSetPage.verifyAfterAdd(NoOfRecordsFinal);
